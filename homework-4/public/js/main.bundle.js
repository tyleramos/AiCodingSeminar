...
(0, _jquery2.default)(function () {
  ...
  var listName = 'quotes';
  var $list = (0, _jquery2.default)('ul.quotes');
  ...
  function refreshList() {
    $list.html('');
    var quotes = _storage2.default.load(listName);
  ...
  (0, _jquery2.default)('form').on('submit', function (e) {
    e.preventDefault();
    var $input = (0, _jquery2.default)('form input[name="quote-input"]');
    var newQuote = $input.val();
    $input.val('');
    _storage2.default.add(listName, newQuote);
    appendQuote(newQuote);
  });

  (0, _jquery2.default)('.clear').on('click', function (e) {
    _storage2.default.empty(listName);
    refreshList();
  });
...
var LOCAL_STORAGE_NAMESPACE = 'simpsons-quotes';

var storageKeyName = function storageKeyName(key) {
  return LOCAL_STORAGE_NAMESPACE + '.' + key;
};

var Storage = {
  add: function add(key, value) {
    var quotes = Storage.load(key);
    quotes.push(value);
